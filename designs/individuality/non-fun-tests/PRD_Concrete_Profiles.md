...
{{Define Behavior of a customer via profile params}}
notes: offboards \< onboards, operates in lower orders
### Merchant Profile
see [[PRD_Concrete_Profiles]]

{{Define Behavior of a customer via profile params}}
notes: accepts small or large payments, mostly takes in coins offboards > onboards, operates in higher orders
