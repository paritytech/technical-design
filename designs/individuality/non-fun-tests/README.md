...
| Claim pilot | [Claim burst](test-design/scenarios/claim-burst.md) | One transfer per predefined coin, sent concurrently | C3.extrinsics, C4.requests, R1.calls, R2.origins, N1.pool, N3.storage | Finalized claims; source consumption and recipient state; time to drain |
