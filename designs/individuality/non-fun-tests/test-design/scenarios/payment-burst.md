...
| **Artifacts** | C2.payment, C3.extrinsics, C4.requests, R1.calls, R2.origins, N1.pool. IDs are defined in the [artifact catalogue](../../coinage/user-flows.md#component-and-artifact-catalogue). |
